...
| **Can Edit** | Regenerate the report snapshot, edit the executive summary, moderate comments (delete or hide). Can also re-share with others up to Edit level. Cannot delete — only the report owner or an Admin can delete a report. |
